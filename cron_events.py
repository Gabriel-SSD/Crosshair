...
if tw_cron:
    update_cron("TW_EVENT", tw_cron, f"{os.getenv('RELATIVE_PATH')}/bronze/tw_leaderboard.py")
else:
...
if tb_cron:
    update_cron("TB_EVENT", tb_cron, f"{os.getenv('RELATIVE_PATH')}/bronze/tb_leaderboard.py")
else:
